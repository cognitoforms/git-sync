...
type DeleteFile =
	| Extract<ConflictFileContentPayload, { type: "deleted_by_us" }>
	| Extract<ConflictFileContentPayload, { type: "deleted_by_them" }>;
...
export function DeleteConflictView({
	...
	const isDeletedByUs = file.type === "deleted_by_us";
