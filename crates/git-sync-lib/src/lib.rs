...
pub use sync::{
    CommandGitTransport, CommitOutcome, ConflictFileContent, ConflictKind, FallbackState,
    GitTransport, RepositoryState, RepositorySynchronizer, ResolvedFileContent, SyncConfig,
    SyncState, UnhandledFileState, FALLBACK_BRANCH_PREFIX,
};
pub use watch::{
